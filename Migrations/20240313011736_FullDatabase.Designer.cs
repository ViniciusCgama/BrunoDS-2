...
namespace OsDsII.api.Migrations
{
    ...
    [Migration("20240313011736_FullDatabase")]
            ...
            modelBuilder.Entity("OsDsII.api.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("SendDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 3, 12, 22, 17, 36, 208, DateTimeKind.Unspecified).AddTicks(9991), new TimeSpan(0, -3, 0, 0, 0)));
            ...
            modelBuilder.Entity("OsDsII.api.Models.ServiceOrder", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("OpeningDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 3, 12, 22, 17, 36, 208, DateTimeKind.Unspecified).AddTicks(4426), new TimeSpan(0, -3, 0, 0, 0)));
